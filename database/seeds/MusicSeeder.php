...
class MusicSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table("genres")->insert(["name" => "EDM"]);
        DB::table("genres")->insert(["name" => "Funk"]);
        DB::table("genres")->insert(["name" => "Hip-Hop"]);
        DB::table("genres")->insert(["name" => "Jazz"]);
        DB::table("genres")->insert(["name" => "Latin"]);
        DB::table("genres")->insert(["name" => "Pop"]);
